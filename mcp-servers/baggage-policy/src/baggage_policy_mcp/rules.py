"""Deterministic demonstration baggage rules (no external calls)."""
...
BAGGAGE_RULES_PATH = Path(__file__).resolve().parents[2] / "data" / "baggage_rules.json"
