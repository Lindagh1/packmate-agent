...
packmate_load_config() {
  ...
  source "${cfg}"
  set +a
  PACKMATE_NAMESPACE="${PACKMATE_NAMESPACE:-${PACKMATE_NS:-packmate-lab}}"
  ...
  export PACKMATE_NAMESPACE PACKMATE_NS MODEL_NAMESPACE MODEL_SERVICE MODEL_ID
  export ODH_APPLICATIONS_NS REGISTER_MCP CREATE_MODEL_CUSTOM_ENDPOINT CREATE_PIPELINE
  export CREATE_ARGOCD_APPLICATION ALLOW_CREATE_NAMESPACE SKIP_CONFIRM
  export GIT_REPO_URL GIT_REVISION LLM_BASE_URL LLM_MODEL LITELLM_API_KEY
